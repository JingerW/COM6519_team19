...
<title>Student Helper - Signup</title>
</head>
...
<form class="w3-container w3-border w3-round" style="width: 300px;margin: auto;margin-top: 20px;" action="Signup" method="post">
  ...
  <p>      
  <label class="w3-text-blue"><b>password Confirm</b></label>
  <input class="w3-input w3-border" name="passconfirm" type="password"></p>
  <p>      
  <button class="w3-button w3-blue">Register</button></p>
</form>
